...
namespace Web_Security_Lab_Day3.Data
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        public DbSet<Web_Security_Lab_Day3.ViewModels.RoleVM> RoleVM { get; set; } = default!;

        public DbSet<Web_Security_Lab_Day3.ViewModels.UserRoleVM> UserRoleVM { get; set; } = default!;
